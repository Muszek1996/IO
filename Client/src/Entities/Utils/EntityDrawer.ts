...
export class EntityDrawer {
    ...
    static create(ship,func): void {
        ...
        BABYLON.SceneLoader.ImportMesh([ship.name], "scenes/", ship.meshFile, SCENE.getInstance(), function (meshes) {
            ...
            ship.mesh.physicsImpostor = new BABYLON.PhysicsImpostor(ship.mesh, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0.1, restitution: 0.01, friction:0.01 }, SCENE.getInstance());//.setDeltaRotation(this._plus90X);
